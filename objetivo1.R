...
mTC <- naiveBayes(TC ~ ., data = as.data.frame(NFJ))
...
C1P1 <- lm(NFJ~C1+P1)
PrC1P1 <- predict(C1P1,C1+P1)
obj1p3a2 <- naiveBayes(PrC1P1 ~ ., data = as.data.frame(NFJ))

C2P2 <- lm(NFJ~C1+P1+C2+P2)
PrC2P2 <- predict(C1P1,data.frame(C1+P1+C2+P2))
obj1p3a3 <- naiveBayes(PrC2P2 ~ ., data = as.data.frame(NFJ))

C3P3 <- lm(NFJ~C1+P1+C2+P2+C3+P3+PF)
PrC3P3 <- predict(C1P1,NFJ)
obj1p3a4 <- naiveBayes(PrC3P3 ~ ., data = as.data.frame(NFJ))
